...
export default function Page() {
  ...
  return (
    <section className="section">
      <h1 className="section-heading">QUẢN LÝ LỊCH ĐẶT/ KHÁM RĂNG</h1>
      <div
        className="filter"
        style={{
          marginBottom: "20px",
      ...
      >
        ...
        <Link
          href="/quan-li-lich-dat/lich-kham-rang/them-lich-dat"
            ...
            <div className="table-row" key={booking.id}>
              ...
              <div className="table-column">
                {booking.bookingStatus === "pending" && (
                  <span className="s-wait">Chờ khám</span>
                )}
                {booking.bookingStatus === "done" && (
                  <span className="s-done">Đã khám</span>
                )}
                {booking.bookingStatus === "cancel" && (
                  <span className="s-cancel">Đã hủy</span>
                )}
              </div>
              <div className="table-column table-edit">
                <Image
                  ...
                  onClick={() => {
                    router.push(
                      `/quan-li-lich-dat/lich-kham-rang/${booking.id}`
                    );
                  }}
                />
                <Image
